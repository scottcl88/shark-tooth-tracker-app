...
export function appInitializer(storageService: StorageService, firebaseAuthService: FirebaseAuthService, loggerService: LoggerService, geocodeService: GeocodeService) {
